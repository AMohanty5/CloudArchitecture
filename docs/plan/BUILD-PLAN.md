...
- [ ] **55** Multi-subnet authoring (reliable drop-into-container, add-subnet, move between subnets) + NACL→subnet chip + **VPC endpoints (Gateway + Interface/PrivateLink)** + inspector "+ Attach…" picker.
